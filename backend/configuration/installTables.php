...
$tables["users"] = "`id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, `name` CHAR(64) NOT NULL, 
					...
					`accepted` TINYINT, `siteid` TINYINT";
